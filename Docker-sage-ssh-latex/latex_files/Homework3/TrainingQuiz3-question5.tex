...
\begin{document}
    ...
    $\textbf{Q5.}$ For the matrix
$A=\begin{bmatrix} a & b \\ c & d \end{bmatrix}$ we have $det(A)=k$
with k≠0. Calculate determinant regarding the matrix\\
$B=\begin{bmatrix} c & d \\ a & b \end{bmatrix}$ ?\\
~\\
$\textbf{Answer :}$

    The determinant of a $2 \times 2$ matrix can be calculated using the
formula:
