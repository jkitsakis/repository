...
To calculate the Hessian matrix $ H $ of the function $LSE(x_1, x_2) = ln(e^{x_1} + e^{x_2})$, we need to compute the second partial derivatives.
...
\item
  ...
  definitively conclude whether the function is convex or not.
\end{enumerate}
