...
from availability.parking_available import parking_avalilability
...
def call_parking_checker_module():
    try:
        parking_avalilability()
    except Exception as e:
        print("An error occurred in the Availability Module:", e)
...
def main():
    ...
    print("3. Maroussi Parking Checker")
