...
\begin{document}
    ...
    $\textbf{Q20.}$ Select the matrix that is neither diagonalizable nor
invertible\\
...
Therefore, the matrix that is neither diagonalizable nor invertible is
matrix $A$.
